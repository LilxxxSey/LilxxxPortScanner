#!/usr/bin/python3
# LilxxxScanner - Multi-threader Port Scanner
# A project by LilxSey
# v1.0.6
# https://github.com/LilxxxSey/Port-Scan
...
\x1b[0;35m
    ...
    print("-" * 60)
    print("LilxxxScanner recommends the following Nmap scan:")
    print("*" * 60)
...
#Nmap Integration (in progress)
    ...
    def automate():
       ...
       while choice =='0':
          ...
          print("2 = Run another LilxxxScanner scan")
